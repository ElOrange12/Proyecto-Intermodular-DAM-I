...
#---------- Esto envia todas las tablas ----------#
cursor.execute('SELECT * FROM piezaportafolio;')	# Muestra las tablas de la base de datos
...
@app.route('/')
def inicio():
	return render_template("backoffice.html",mis_tablas = tablas, mis_columnas = columnas, mi_contenido_tabla = contenido_tabla)	# Envio las tablas a HTML
